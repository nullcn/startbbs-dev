...
<a href="<?php echo site_url();?>" class="startbbs">StartBBS</a> <span class="chevron">&nbsp;›&nbsp;</span> <a href="<?php echo site_url('admin/');?>">管理后台</a> <span class="chevron">&nbsp;›&nbsp;</span> 分类节点
</div>
</div>
<div id='planes'>
...
<div class='cell node' id='node_1'>
<div class='fr'>
<a href="<?php echo site_url('/admin/nodes/edit/'.$s['cid']);?>" class="btn btn-small" data-remote="true" id="edit_node_1">修改节点</a>
<a href="<?php echo site_url('/admin/nodes/move/'.$s['cid']);?>" class="btn btn-small" data-remote="true">移动</a>
<a href="<?php echo site_url('/admin/nodes/del/'.$s['cid']);?>" class="btn btn-small btn-danger" data-confirm="真的要删除吗?" data-method="delete" data-remote="true" rel="nofollow">删除</a>
</div>
