...
<a href="<?php echo site_url();?>" class="startbbs1">StartBBS</a> <span class="chevron">&nbsp;›&nbsp;</span> <a href="<?php echo site_url('admin/');?>">管理后台</a> <span class="chevron">&nbsp;›&nbsp;</span> 添加分类
</div>
<div class='cell'>
...
<div class="controls">
<input class="string required" id="cname" name="cname" size="50" type="text" value="<?php echo $cateinfo['cname']?>" /></div></div>
...
<option selected="selected" value="<?php echo $cateinfo['pid']?>"><?php echo $cateinfo['pid']?></option>
...
<div class="controls">
<input class="string optional" id="keywords" name="keywords" size="50" type="text" value="<?php echo $cateinfo['keywords']?>" /></div></div>
<div class="control-group text optional">
<label class="text optional control-label" for="content">分类简介</label>
<div class="controls">
<textarea class="text optional span4" cols="40" id="content" name="content" rows="5"><?php echo $cateinfo['content']?></textarea></div></div>
