...
<div class="controls">
<input class="string required" id="title" name="title" size="50" type="text" value="<?php echo $page['title'];?>" />
</div>
</div>
<div class="control-group string required">
<label class="string required control-label" for="content">内容</label>
<div class="controls">
<textarea class="span5" id="content" name="content" rows="10"><?php echo $page['content'];?></textarea>
</div>
</div>
<div class="control-group email optional">
<label class="email optional control-label" for="go_url">转向url</label>
<div class="controls">
<input class="string email optional" id="go_url" name="go_url" size="60" type="text" value="<?php echo $page['go_url'];?>" />
...
<input class="btn btn-small btn-primary" name="commit" type="submit" value="编辑页面" />
</div>
</form>
</div>
</div>
