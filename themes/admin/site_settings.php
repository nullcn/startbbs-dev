...
<li><a href="#tab3" data-toggle="tab">邮件配置</a></li>
<li><a href="#tab4" data-toggle="tab">自定义url</a></li>
...
<div class='control-group'>
<label class="control-label" for="protocol">邮件发送方式：</label>
<div class='controls'>
<label class='radio inline'>
...
<div class='control-group'>
<label class="control-label" for="settings_smtp_host">SMTP 服务器:</label>
<div class='controls'>
<input id="settings_site_name" name="smtp_host" type="text" value="<?php echo $this->config->item('smtp_host');?>" />
<small class='help-inline'>设置 SMTP 服务器的地址</small>
</div>
</div>
<div class='control-group'>
<label class="control-label" for="settings_smtp_port">SMTP端口:</label>
<div class='controls'>
<input class="span1" id="settings_smtp_port" name="smtp_port" type="text" value="<?php echo $this->config->item('smtp_port');?>" />
<small class='help-inline'> 设置 SMTP 服务器的端口，默认为 25</small>
</div>
</div>

<div class='control-group'>
<label class="control-label" for="settings_smtp_user">发信人邮件地址:</label>
<div class='controls'>
<input id="settings_smtp_user" name="smtp_user" type="text" value="<?php echo $this->config->item('smtp_user');?>" />
<small class='help-inline'>@发信人邮件地址</small>
</div>
</div>

<div class='control-group'>
<label class="control-label" for="settings_smtp_pass">邮箱密码:</label>
<div class='controls'>
<input id="settings_smtp_user" name="smtp_pass" type="text" value="<?php echo $this->config->item('smtp_pass');?>" />
...
<div class="control-group">
<label class="control-label" for="settings_flist_url">列表页url:</label>
<div class="controls">
<input id="settings_flist_url" name="flist_url" type="text" value="<?php echo $routes[6];?>" />
<small class="help-inline">贴子列表页地址</small>
</div>
</div>
<div class="control-group">
<label class="control-label" for="settings_view_url">内容页url:</label>
<div class="controls">
<input id="settings_view_url" name="view_url" type="text" value="<?php echo $routes[7];?>" />
