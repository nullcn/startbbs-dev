...
<div class="controls">
<input class="string required" id="user_nickname" name="username" size="50" type="text" value="<?=$user['username']?>" /></div></div>
<div class="control-group email optional">
<label class="email optional control-label" for="user_email">电子邮件</label>
<div class="controls">
<input class="string email optional" id="user_email" name="email" size="50" type="email" value="<?=$user['email']?>" /></div></div>
...
<div class="controls">
<input class="string optional" id="user_account_attributes_personal_website" name="homepage" size="50" type="text" value="<?=$user['homepage']?>" /></div></div>
<div class="control-group string optional">
<label class="string optional control-label" for="user_account_attributes_location">所在地</label>
<div class="controls">
<input class="string optional" id="user_account_attributes_location" name="location" size="50" type="text" value="<?=$user['location']?>" />
</div>
</div>
<div class="control-group string optional">
<label class="string optional control-label" for="user_account_attributes_weibo_link">QQ</label>
<div class="controls">
<input class="string optional span4" id="user_account_attributes_weibo_link" name="qq" size="50" type="text" value="<?=$user['qq']?>" />
</div>
</div>
<div class="control-group string optional">
<label class="string optional control-label" for="user_account_attributes_signature">签名</label>
<div class="controls">
<input class="string optional span4" id="user_account_attributes_signature" name="signature" size="50" type="text" value="<?=$user['signature']?>" />
</div></div>
<div class="control-group text optional">
<label class="text optional control-label" for="user_account_attributes_introduction">个人简介</label>
<div class="controls">
<textarea class="text optional span4" cols="40" id="user_account_attributes_introduction" name="introduction" rows="5"><?=$user['introduction']?></textarea></div></div>
<input id="user_account_attributes_id" name="uid" type="hidden" value="<?=$user['uid']?>" />
<div class="control-group integer optional">
<label class="integer optional control-label" for="user_reward">银币</label><div class="controls">
<input class="numeric integer optional" id="user_reward" name="money" step="1" type="number" value="<?=$user['money']?>" />
</div></div>
