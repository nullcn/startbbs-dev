  			...
  			<fieldset>
    			<div class="control-group">
      				...
      				<div class="controls">
      					<p>
      					<?php if ($user['avatar']){?>
      						<img src="<?php echo base_url($avatars['big']); ?>"/>
      						<img src="<?php echo base_url($avatars['middle']); ?>"/>
      						<img src="<?php echo base_url($avatars['small']); ?>"/>
      					<?php } else {?>
							<img src="<?php echo base_url('uploads/avatar/avatar_large.jpg');?>"/>
      						<img src="<?php echo base_url('uploads/avatar/default.jpg');?>"/>
      						<img src="<?php echo base_url('uploads/avatar/avatar_small.jpg');?>"/>
      					<?php }?>
      					</p>
